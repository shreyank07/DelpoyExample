...
namespace ProdigyFramework.Model
{
    ...
    public class LoadingAdorner : Adorner
    {
        ...
        public static readonly DependencyProperty ColorProperty =
            ...
            new PropertyMetadata((Brush)new BrushConverter().ConvertFromString("#1C4047F7")));
        ...
        protected override void OnRender(System.Windows.Media.DrawingContext drawingContext)
        {
            ...
            Point p = new Point(this.ActualWidth / 2, this.ActualHeight / 2);
            drawingContext.DrawText(text, new Point(p.X - text.WidthIncludingTrailingWhitespace / 2, p.Y - text.Height / 2));
